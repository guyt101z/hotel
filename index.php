...
else // For local environments
{
    ...
    set_include_path(implode(PATH_SEPARATOR, array(realpath('/Applications/MAMP/htdocs/ZendFramework-1.11.12/library'), realpath('C:\wamp\www\ZendFramework-1.12.0\library'), get_include_path())));
